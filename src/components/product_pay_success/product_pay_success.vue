  ...
  <div class="wait_pay">
    ...
    <div class="cantuan">
      <div class="cantuan_container">
        ...
        <div class="buttton_container" v-show="datad.status !== '待发货'">
          <div class="buttond" @click="quxiao">
            取消订单
          </div>
          <div class="buttont" @click="tijiao" v-show="datad.status !== '待发货'">
            立即付款
          </div>
...
//        this.show = !this.show
//        //
//        this.$store.commit('class_order_edit', this.datad)
...
//    created () {
//      // 点击订单中心会给vuex的dingdan_xiangqing_id赋值
